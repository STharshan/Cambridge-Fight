...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black/60 text-white px-6 md:px-12 lg:px-20 shadow-md fixed w-full z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between h-22">
        {/* Logo */}
