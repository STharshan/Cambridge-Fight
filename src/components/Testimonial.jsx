      ...
      <div className="relative max-w-6xl mx-auto" data-aos="fade-up" data-aos-delay="300">
        ...
        >
          {trainers.map((trainer, index) => (
            <div
              key={index}
              className="w-64 h-85 bg-[#111] rounded-xl border border-gray-200  overflow-hidden flex-shrink-0 shadow-lg hover:scale-105 transition-transform duration-300"
              data-aos="zoom-in"
            ...
            >
              <div className="relative">
                <img
                  src="/logo.png"
                  alt={trainer.name}
                  className="h-55 w-55 mt-5 mx-auto object-cover"
                />
